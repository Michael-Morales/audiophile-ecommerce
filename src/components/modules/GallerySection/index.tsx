...
const GallerySection = ({ first, second, third, productName }: Props) => {
  ...
  return (
    <div className="mt-[5.5rem] mb-[7.5rem] grid grid-rows-[repeat(2,174px)_368px] gap-y-5 gap-x-[1.125rem] sm:my-[7.5rem] sm:grid-cols-5 sm:grid-rows-[repeat(2,174px)] lg:my-40 lg:grid-rows-[repeat(2,280px)] lg:gap-y-8 lg:gap-x-[1.875rem]">
      <div className="relative w-full overflow-hidden rounded-lg bg-pale-grey sm:col-start-1 sm:col-end-3 sm:row-start-1 sm:row-end-2">
        <Image
          mobile={first.mobile}
          tablet={first.tablet}
      ...
      <div className="relative w-full overflow-hidden rounded-lg bg-pale-grey sm:col-start-1 sm:col-end-3 sm:row-start-2 sm:row-end-3">
        <Image
      ...
      <div className="relative w-full overflow-hidden rounded-lg bg-pale-grey sm:col-start-3 sm:col-end-6 sm:row-start-1 sm:row-end-3">
        <Image
          mobile={third.mobile}
          tablet={third.tablet}
